...
public class MyBatisPlusGenerator {
    ...
    //要生成的表名
    private static final String[] TABLES= {"t_pay"};
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/db2024" ;
    private static final String JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "root";
    private static final String BASE_PACKAGE = "com.atguigu.cloud";

    public static void main(String[] args) {
        //当前项目路径
        String projectPath = System.getProperty("user.dir")+"/mybatis_generator2024";
